  ...
  return (
    ...
    >
      ...
      <ul className='py-3 px-2'>
        <li className='flex flex-col justify-between '>
          <div className='flex justify-between '>
            <h3 className='viewMore'>
              ₦{formatNumInThousands(price)} <span>/{paymentType}</span>{' '}
            </h3>
        ...
        <li className='flex gap-2 justify-between border-t-[1px] border-Line mt-3 pt-3'>
